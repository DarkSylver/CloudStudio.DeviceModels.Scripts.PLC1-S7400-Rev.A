...
function getEndpoints(deviceAddress, endpoints)
{
   ...
   endpoints.addEndpoint("FIT8005", "Caudal Crema a Empaque", endpointType.flowSensor);
   var e = endpoints.addEndpoint("FIT8005_TOT", "Totalizado Caudal Crema a Empaque", endpointType.genericSensor);
   e.variableTypeId = 1029;
   endpoints.addEndpoint("TT_Glicol_Termo", "Temperatura de Glicol Termos", endpointType.temperatureSensor);
   endpoints.addEndpoint("Coccion_TT_Mosto_Cal", "Temperatura Mosto Caliente", endpointType.temperatureSensor);
   endpoints.addEndpoint("Coccion_TT_Mosto_Frio", "Temperatura Mosto Frio", endpointType.temperatureSensor);
  // endpoints.addEndpoint("2", "CO2 sensor", endpointType.ppmConcentrationSensor, ppmConcentrationSensorSubType.carbonDioxide);
   //SP PRESION DEL COLECTOR
    var e = endpoints.addEndpoint("SPPresionColector", "SP Presion Colector Aire", endpointType.genericSensor);
    e.variableTypeId = 1021;
    var e = endpoints.addEndpoint("LT-609", "Nivel Tanque 609", endpointType.genericSensor);
   e.variableTypeId = 1029;
}
