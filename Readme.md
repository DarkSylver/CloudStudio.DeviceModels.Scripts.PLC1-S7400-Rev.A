...
# Parsing + Configuration Script – PLC1-S7 400 - Rev. A

This **Parsing + Configuration** script is designed for the **PLC1-S7 400** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – PLC1-S7 400 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **PLC1-S7 400** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
